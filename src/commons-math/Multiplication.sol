...
contract Multiplication is Application {

    /**
     * @dev Reads the IN-data mapping ID "First Number" from the BpmService, and the IN-data mapping ID "Second Number, multiplies them, and stores it back via an OUT-data mapping.
