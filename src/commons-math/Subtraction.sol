...
contract Subtraction is Application {

    /**
     * @dev Reads the IN-data mapping ID "First Number" from the BpmService, and the IN-data mapping ID "Second Number, subtracts them, and stores it back via an OUT-data mapping.
